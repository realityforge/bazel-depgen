...
4. Document any intentionally omitted Ariake checks with evidence.
...
- Omit `Varifier`; a source scan found hundreds of candidate local declarations, making it broad mechanical churn rather than a focused strictness improvement.
