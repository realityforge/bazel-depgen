...
### [v#{ENV['PRODUCT_VERSION']}](https://github.com/realityforge/bazel-depgen/tree/v#{ENV['PRODUCT_VERSION']}) (#{ENV['RELEASE_DATE']})
[Full Changelog](https://github.com/realityforge/bazel-depgen/compare/#{from}...v#{ENV['PRODUCT_VERSION']})
HEADER
