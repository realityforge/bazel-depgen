...
public final class ApplicationRecord
{
  ...
  void replacement( @Nonnull final DependencyNode node )
  {
    ...
    assert null != model;
    final ArtifactRecord record = new ArtifactRecord( this, node, null, null, null, null, null, null, null, model );
                 ...
                 @Nullable final List<String> processors )
  {
    ...
    final ArtifactRecord record =
      new ArtifactRecord( this, node, sha256, urls, sourceSha256, sourceUrls, licenses, processors, model, null );
    if ( null != model &&
