...
public final class ArtifactModel {
    ...
    public static ArtifactModel parse(final ArtifactConfig source) {
    ...
    private static void validateRepositoryNamingConfig(final ArtifactConfig source) {
    ...
    private static void validateUserSpecifiedTargetNames(final ArtifactConfig source) {
    ...
    private static void validateNameOverride(
            final String fieldName, @Nullable final String name, final ArtifactConfig source) {
    ...
    public List<Nature> getNatures(final Nature defaultNature) {
