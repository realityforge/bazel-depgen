...
public class ResolverUtilTest extends AbstractTest {
    @Test
    public void getRemoteRepositories() throws Exception {
        final List<RepositoryModel> repositories = Arrays.asList(
    ...
    public void createResolver() throws Exception {
        ...
        // Install jar into local repository
        {
            ...
            assertTrue(localRepository
                    .resolve("com/example/myapp/1.0.0/myapp-1.0.0.pom")
                    .toFile()
                    .exists());
            assertTrue(localRepository
                    .resolve("com/example/myapp/1.0.0/myapp-1.0.0.pom.sha1")
                    .toFile()
                    .exists());
            assertTrue(localRepository
                    .resolve("com/example/myapp/1.0.0/myapp-1.0.0.jar")
                    .toFile()
                    .exists());
            assertTrue(localRepository
                    .resolve("com/example/myapp/1.0.0/myapp-1.0.0.jar.sha1")
                    .toFile()
                    .exists());
        }
        ...
        // Download from local repository to local cacheDir
        {
            ...
            assertTrue(cacheDir.resolve("com/example/myapp/1.0.0/myapp-1.0.0.jar")
                    .toFile()
                    .exists());
            assertTrue(cacheDir.resolve("com/example/myapp/1.0.0/myapp-1.0.0.jar.sha1")
                    .toFile()
                    .exists());
        }
    }
