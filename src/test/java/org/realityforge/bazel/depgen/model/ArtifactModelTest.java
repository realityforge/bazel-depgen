...
public class ArtifactModelTest extends AbstractTest {
    ...
    public void parseArtifactWithRepositoryNameContainingDoubleUnderscore() {
        ...
        final InvalidModelException exception =
                expectThrows(InvalidModelException.class, () -> ArtifactModel.parse(source));
        assertEquals(exception.getMessage(), "The dependency repositoryName 'my__app' must not contain '__'.");
        assertEquals(exception.getModel(), source);
    }
    ...
    public void parseArtifactWithInvalidJavaName() {
        ...
        final InvalidModelException exception =
                expectThrows(InvalidModelException.class, () -> ArtifactModel.parse(source));
        assertEquals(exception.getMessage(), "The dependency java.name property must not contain '__'.");
        assertEquals(exception.getModel(), source);
    }
    ...
    public void parseArtifactWithInvalidJ2clName() {
        ...
        final InvalidModelException exception =
                expectThrows(InvalidModelException.class, () -> ArtifactModel.parse(source));
        assertEquals(exception.getMessage(), "The dependency j2cl.name property must not contain '__'.");
        assertEquals(exception.getModel(), source);
    }
    ...
    public void parseArtifactWithInvalidPluginName() {
        ...
        final InvalidModelException exception =
                expectThrows(InvalidModelException.class, () -> ArtifactModel.parse(source));
        assertEquals(exception.getMessage(), "The dependency plugin.name property must not contain '__'.");
        assertEquals(exception.getModel(), source);
    }
    ...
    public void parseArtifactWithNaturesSpecified() {
        ...
        assertEquals(ArtifactModel.parse(source).getNatures(Nature.Java), Arrays.asList(Nature.Java, Nature.J2cl));
    }
