...
public class ApplicationModelTest extends AbstractTest {
    ...
    @Test
    public void explicitDepGenArtifactListed() throws Exception {
    ...
    @Test
    public void explicitDepGenMarkedAsReplacement() throws Exception {
    ...
    public void getRepository() throws Exception {
        ...
        assertEquals(model.getRepository(ApplicationConfig.MAVEN_CENTRAL_NAME), repositories.get(0));
        assertThrows(() -> model.getRepository("other"));
    }
    ...
    public void ensureArtifactRepositoriesAlign() throws Exception {
        ...
        final DepgenValidationException exception =
                expectThrows(DepgenValidationException.class, this::loadApplicationModel);

        assertEquals(
                exception.getMessage(),
                "Artifact 'com.example:myapp' declared a repository named 'NoExist' but no such repository is declared"
                        + " in the repository section. Known repositories include: local");
    }
}
